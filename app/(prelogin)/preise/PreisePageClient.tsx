...
export function PreisePageClient() {
                  ...
                  <Card className="rounded-2xl border-border">
                    <CardContent className="py-5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Ja, Sie können jederzeit auf einen höheren Tarif upgraden. Die Differenz wird anteilig berechnet.
                        Ein Downgrade ist zum Ende der aktuellen Abrechnungsperiode möglich. Ihre Daten bleiben dabei
                ...
                <div className="grid gap-5">
                  ...
                  <Card className="rounded-2xl border-border">
                    <CardContent className="py-5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Alle Tarife beinhalten: Buchungsverwaltung, Kundenverwaltung, GoBD-konforme
                        Rechnungserstellung, Basis-Reporting, mobile Optimierung und SSL-Verschlüsselung. Die
                        erweiterten Features wie API-Zugang, Fahrer-App und KI-Funktionen sind ab dem Business-Tarif
                        verfügbar.
                      </p>
                    </CardContent>
                  </Card>

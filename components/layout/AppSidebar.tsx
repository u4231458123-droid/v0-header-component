...
/* ==================================================================================
   AppSidebar V26.2 - v0-kompatibel mit Inline-SVG Icons
   ==================================================================================
   ...
   ✅ V26.2: lucide-react durch Inline-SVGs ersetzt für v0-Kompatibilität
   ================================================================================== */
...
const FileText = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <path d="M14 2v4a2 2 0 0 1 0 7.75" />
    <path d="M10 9H8" />
    <path d="M16 13H8" />
    <path d="M16 17H8" />
  </svg>
...
const Truck = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 1 1 1h2" />
    <path d="M15 18H9" />
    <path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.624l-3.48-4.35A1 1 0 0 1 17.52 8H14" />
...
const Zap = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z" />
  </svg>
)
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Fahrer & Fahrzeuge", url: "/fahrer", icon: Truck },
        { title: "Schichtzettel", url: "/schichtzettel", icon: Calendar },
    ...
    },
    {
      label: "GESCHÄFT",
      items: [
        { title: "Partner", url: "/partner", icon: Handshake, requiredTariff: "Business" },
        { title: "Statistiken", url: "/statistiken", icon: TrendingUp, requiredTariff: "Business" },
      ],
    },
    {
      label: "SYSTEM",
...
const navigationItems = [
  ...
  { href: "/fahrer", label: "Fahrer", icon: DriversIcon },
  { href: "/fleet", label: "Flotte", icon: FleetIcon },
  { href: "/kunden", label: "Kunden", icon: CustomersIcon },
  { href: "/rechnungen", label: "Rechnungen", icon: InvoicesIcon },
    ...
    >
      <div className="flex items-center h-16 px-4 border-b border-sidebar-border">
        <Link href="/dashboard" className="flex items-center gap-3 min-w-0">
          ...
          {!isCollapsed && <span className="font-semibold text-lg text-sidebar-foreground truncate">MyDispatch</span>}
        </Link>
      </div>
      ...
      <div className="border-t border-sidebar-border p-3">
        {loading ? (
          ...
          <div className="relative">
            ...
            >
              {/* Avatar */}
              <div className="relative shrink-0 w-9 h-9 rounded-full bg-primary flex items-center justify-center">
